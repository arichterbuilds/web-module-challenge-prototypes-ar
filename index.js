...
/* 
  ...
  1. Window Binding: when the other rules don't apply, it will return the window, global object, or undefined.
  2. Implicit Binding: when a function is invoked to look to the left of the dot
  3. Explicit Binding: .call, .apply, .bind
  4. New Binding: a function that is a constructor which points to the newly created object
*/
